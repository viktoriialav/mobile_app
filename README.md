...
- Тестирование стартовых страниц и настроек:
  * Проверка заголовков всех стартовых страниц и открытия главной страницы
...
- Тестирование основных функций главной страницы:
  ...
  * Проверка работы функционала кнопки "Save and create"
...
[Ссылка на задачу в Jira.](https://jira.autotests.cloud/browse/HOMEWORK-1351)
